...
const HomeContent = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100 p-6">
      ...
      <h1 className={`text-6xl mb-20 mt-40 font-semibold ${
        i18n.language === "en" ? "font-jost" : "font-amharic"
      }`}>
        {t("header_text")}
      </h1>

      <div {...getRootProps()} className="w-full max-w-3xl h-80 border-4 border-dashed border-gray-300 rounded-xl flex justify-center items-center cursor-pointer bg-white text-center p-4">
        <input {...getInputProps()} />
        <div>
      ...
      {image && previewUrl && (
        <div className="mt-8 text-center relative">
          ...
          <img src={previewUrl} alt="Preview" className="mt-4 max-w-full max-h-96 rounded-lg shadow-lg" />
        </div>
      )}
